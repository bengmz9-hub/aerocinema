...
import { Mail, Compass, DollarSign, X, ChevronDown, CheckCircle2 } from "lucide-react";
        ...
        >
          ...
          {submitted ? (
            <div className="flex flex-col items-center justify-center space-y-4 py-16 text-center">
              <CheckCircle2 size={48} className="text-white/80" strokeWidth={1.25} />
              ...
              <p className="max-w-sm font-sans text-sm font-light text-white/50">
                Plan de vuelo inicial en preparación. Nos pondremos en
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs leading-relaxed">
                        Analizamos la zona de vuelo, gestionamos permisos CTR
                        y coordinamos con helipuertos o aeropuertos oficiales.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">

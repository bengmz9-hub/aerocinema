...
export default function ContactSection() {
	...
	const selectedMessage =
		...
		DEFAULT_MESSAGE;
	const whatsappUrl = getWhatsAppLink(CONTACT_PHONE, selectedMessage);

	return (
		<section className="relative mx-auto max-w-7xl px-4 sm:px-6 pt-8 pb-12 md:py-20 lg:px-8 text-center select-none z-10">
			<div className="mx-auto flex max-w-2xl flex-col items-center justify-center gap-4 md:gap-6">
				...
				<fieldset className="mt-6 flex flex-wrap items-center justify-center gap-2.5 w-full max-w-xl border-0 p-0 m-0">
				...
				<div className="mt-5 w-full max-w-xl rounded-2xl border border-gold-500/20 bg-[#12141a] px-5 py-4 md:px-6 md:py-5 text-left shadow-[0_4px_20px_rgba(0,0,0,0.2)]">
					...
					<p className="font-jakarta text-sm md:text-base text-zinc-200 font-medium leading-relaxed">
						{selectedMessage}
					</p>
				</div>
					...
					>
						...
						<div className="relative z-10 flex flex-col items-center justify-center mb-2.5">
							<div className="relative flex items-center justify-center p-2.5 rounded-xl bg-gold-500/10 border border-gold-500/20">
								...
								<span className="absolute -top-0.5 -right-0.5 w-1.5 h-1.5 rounded-full bg-[#dfd0a4] opacity-80 shadow-[0_0_6px_rgba(223,208,164,0.8)]" />
							</div>
						</div>

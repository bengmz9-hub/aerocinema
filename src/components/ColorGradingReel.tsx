...
export function ColorGradingReel() {
	...
	return (
		<section className="w-full bg-transparent py-16 md:py-24 px-4 md:px-8 select-none">
			<div className="max-w-7xl mx-auto">
				...
				<div className="flex flex-col md:flex-row md:items-end justify-between mb-8 md:mb-12 gap-6">
					<div>
						<div className="flex items-center gap-3 mb-2">
							...
							<span className="text-gold-400 text-[10px] font-mono tracking-[0.3em] uppercase">
				...
				<div className="relative w-full rounded-2xl overflow-hidden border border-white/15 bg-zinc-950 shadow-2xl group">
					<div
						...
						className="relative h-[260px] xs:h-[320px] sm:h-[400px] md:h-[500px] w-full overflow-hidden cursor-ew-resize select-none touch-none focus:outline-none focus-visible:ring-2 focus-visible:ring-gold-400"
					>
						...
						>
							<div className="w-0.5 h-full bg-gradient-to-b from-gold-400 via-white to-gold-400 shadow-[0_0_12px_rgba(223,208,164,0.8)]" />
							<div className="absolute w-8 h-8 rounded-full bg-black/90 border-2 border-amber-300 shadow-[0_0_20px_rgba(252,211,77,0.45)] flex items-center justify-center text-amber-300 transition-transform group-hover:scale-110">
					...
					<div className="p-4 sm:p-6 bg-[#0a0c10]/90 border-t border-white/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
						<div>
							<div className="flex items-center gap-2 text-[10px] font-mono text-gold-400 tracking-wider uppercase mb-1">
								...
								return (
									<button
										...
										className={cn(
											...
											isActive
												? "ring-2 ring-gold-400 ring-offset-2 ring-offset-black scale-102 z-10"
									...
									>
										...
										{isActive && (
											<div className="absolute top-2 right-2 p-1 rounded-full bg-gold-400 text-black shadow-lg">
												<Check className="w-3 h-3 stroke-[3]" />
											</div>
										)}

										<div className="absolute bottom-0 left-0 right-0 p-3">
											<span className="text-[8px] font-mono uppercase tracking-widest text-amber-300 block mb-0.5">

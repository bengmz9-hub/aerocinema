...
export default function WhatsAppButton({
	...
	return (
		<a
			...
			className="fixed bottom-20 md:bottom-6 right-4 md:right-6 z-40 md:z-50 flex items-center gap-2.5 bg-[#25D366] hover:bg-[#20bd5a] text-zinc-950 font-bold px-4 py-3 rounded-full shadow-lg shadow-black/50 hover:scale-105 transition-all duration-300 group focus-visible:ring-2 focus-visible:ring-white min-h-[44px] min-w-[44px]"
		>
			<svg
			...
			<span className="hidden md:inline text-sm font-bold tracking-wide pr-1">

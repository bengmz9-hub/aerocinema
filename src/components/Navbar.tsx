			...
			>
				...
				>
					...
					<a
						...
						className={`mt-4 border border-amber-500/30 bg-amber-500/10 px-6 py-4 text-center font-sans text-xs uppercase tracking-[0.28em] text-amber-200 font-semibold transition-all duration-500 hover:bg-amber-500/20 hover:border-amber-400/50 ${

  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: gradientFirst || "radial-gradient(50% 50% at 50% 50%, rgba(255, 255, 255, 0.06) 0%, rgba(255, 255, 255, 0) 100%)",
        }}
      />
      ...
      <div
        ...
        style={{
          background: gradientSecond || "radial-gradient(50% 50% at 50% 50%, rgba(255, 255, 255, 0.02) 0%, rgba(255, 255, 255, 0) 100%)",
        }}
      />
    </div>
  );

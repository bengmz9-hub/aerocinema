	...
	return (
		...
		>
			<div className="relative flex w-full flex-1 items-center justify-center isolate z-0">
				{/* Cono Izquierdo - Proyección sutil hacia abajo (opacity 0.15) */}
				<motion.div
					initial={{ opacity: 0.03, width: "24rem" }}
					whileInView={{ opacity: 0.15, width: "42rem" }}
					transition={{
						delay: 0.1,
						duration: 1.0,
						ease: "easeInOut",
					...
					className="absolute inset-auto right-1/2 h-16 overflow-visible w-[42rem] bg-gradient-conic from-[#dfd0a4]/15 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
				/>

				{/* Cono Derecho - Proyección sutil hacia abajo (opacity 0.15) */}
				<motion.div
					initial={{ opacity: 0.03, width: "24rem" }}
					whileInView={{ opacity: 0.15, width: "42rem" }}
					transition={{
					...
					className="absolute inset-auto left-1/2 h-16 w-[42rem] bg-gradient-conic from-transparent via-transparent to-[#dfd0a4]/15 text-white [--conic-position:from_290deg_at_center_top]"
				/>
				...
				{/* Baño de iluminación sutil centrado únicamente sobre la lámpara (opacity 0.15) */}
				<div className="absolute top-0 left-1/2 -translate-x-1/2 w-[36rem] h-20 bg-gradient-to-b from-[#dfd0a4]/15 via-[#dfd0a4]/04 to-transparent pointer-events-none" />
			</div>

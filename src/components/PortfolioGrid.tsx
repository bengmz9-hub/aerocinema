...
const CardContent = ({ title, category, description }: CardContentProps) => {
  return (
    <div className="font-montserrat">
      ...
      <p className="font-light text-xs md:text-sm my-3 max-w-lg text-zinc-300 leading-relaxed">
        {description}
      </p>
    </div>
  );
...
export function PortfolioGrid() {
  ...
  return (
    <section className="w-full bg-transparent py-24 px-4 md:px-8 border-t border-white/[0.06] relative overflow-x-clip overflow-y-visible z-0">
      ...
      <Spotlight className="top-0 left-0" gradientFirst={focusLight} gradientSecond={ambientLight} />
      <Spotlight className="top-0 right-0" gradientFirst={focusLight} gradientSecond={ambientLight} />
      <Spotlight className="bottom-0 left-0" gradientFirst={focusLight} gradientSecond={ambientLight} />
      <Spotlight className="bottom-0 right-0" gradientFirst={focusLight} gradientSecond={ambientLight} />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="h-[550px] md:h-[760px] w-full rounded-xl overflow-hidden border border-white/[0.06] bg-zinc-950/10 backdrop-blur-xs">

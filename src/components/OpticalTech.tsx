				...
				<div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
					...
					<div className="lg:col-span-7 order-2 lg:order-1 flex flex-col gap-6 font-montserrat">
						<p className="font-light text-zinc-400 text-sm md:text-base leading-relaxed tracking-wide mb-4 max-w-2xl">
							...
							industrial. Esto nos permite registrar texturas puras, gestionar
							rangos dinámicos extremos bajo el sol del mediterráneo y entregar
							piezas listas para corrección de color profesional.
						</p>
						...
						<div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full">
							<div className="p-6 bg-white/[0.01] border border-white/[0.03] rounded-2xl hover:border-emerald-500/20 hover:bg-white/[0.02] transition-all duration-300">
								...
								<p className="text-zinc-500 text-xs font-light leading-relaxed">
									Resolución nativa en 5.1K con perfiles de color logarítmicos
									(D-Log de 10 bits) para una flexibilidad extrema en
									postproducción.
								</p>
							</div>
							...
							<div className="p-6 bg-white/[0.01] border border-white/[0.03] rounded-2xl hover:border-emerald-500/20 hover:bg-white/[0.02] transition-all duration-300">
								...
								<p className="text-zinc-500 text-xs font-light leading-relaxed">
									Gimbal mecánico de alta precisión que compensa ráfagas de
									viento de hasta 12 m/s, garantizando tomas fluidas como la
									seda.
								</p>
							</div>
							...
							<div className="p-6 bg-white/[0.01] border border-white/[0.03] rounded-2xl hover:border-emerald-500/20 hover:bg-white/[0.02] transition-all duration-300">
								...
								<p className="text-zinc-500 text-xs font-light leading-relaxed">
									Enlace de vídeo Full HD a 60 fps con latencia ultra-baja para
									un encuadre y dirección artística milimétrica en tiempo real.
								</p>
							</div>
							...
							<div className="p-6 bg-white/[0.01] border border-white/[0.03] rounded-2xl hover:border-emerald-500/20 hover:bg-white/[0.02] transition-all duration-300">
								...
								<p className="text-zinc-500 text-xs font-light leading-relaxed">
									Eliminación total del efecto de barrido distorsionado (rolling
									shutter) en vuelos de alta velocidad y paneos rápidos.
								</p>
							</div>
						</div>
					</div>
